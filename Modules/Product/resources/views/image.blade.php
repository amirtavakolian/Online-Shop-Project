...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-xl-12 col-md-12 mb-4 p-5 bg-white">
                    ...
                    <div class="col-md-3">
                        <div class="card">
                            ...
                            <div class="card-body text-center">
                                <form action="{{ route('product.images.delete', ['product' => $product]) }}" method="post">
                                    @method('DELETE')
                                    @csrf
                                    <input type="hidden" name="image_id" value="{{ $image->image }}">
            ...
            <form action="{{ route('product.images.update', ['product' => $product]) }}" method="POST"
