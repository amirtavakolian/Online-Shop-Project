...
<script src="{{ asset('modules/panel/js/jquery.min.js') }}"></script>
<script src="{{ asset('modules/panel/js/bootstrap.bundle.min.js') }}"></script>
<script src="{{ asset('modules/panel/js/jquery.easing.min.js') }}"></script>
<script src="{{ asset('modules/panel/js/sb-admin-2.min.js') }}"></script>
