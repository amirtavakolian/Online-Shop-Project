            ...
            <div class="row">
                @foreach($indexTopBanners as $indexTopBanner)
                    <div class="col-lg-4 col-md-4">
                        <div class="single-banner mb-30 scroll-zoom">
                            <a href="{{ url($indexTopBanner->button_link) }}"><img class="animated"
                                                                                   src="{{ asset('storage/'.$indexTopBanner->image) }}"
                                                                                   alt=""/></a>
                ...
                @foreach($indexBottomBanners as $indexBottomBanner)
                    <div class="col-lg-6 col-md-6">
                        <div class="single-banner mb-30 scroll-zoom">
                            <a href="{{ $indexBottomBanner->button_link }}"><img class="animated"
                                                                                 src="{{ asset('storage/'.$indexBottomBanner->image) }}"
                                                                                 alt=""/></a>
