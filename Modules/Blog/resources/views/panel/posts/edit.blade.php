...
@section('content')
    <div class="single_post">
        <div class="container-fluid">
            ...
            <form method="POST" action="{{ route('blog.posts.update', ['post'=>$post->id]) }}"
                ...
                <div class="col-md-8">
                    ...
                    <div class="post_content text-center">
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    ...
                                    <img src="{{ asset('storage/'.$post->image_url) }}" width="120" height="100">
                                </div>

                                <div class="col-sm-4">
                                    <label for="exampleInputEmail1">نام عکس:</label>
                                    <input type="text" value="{{ $post->imageName }}" name="image_name"
                                           class="form-control ">
                                </div>
                                <div class="col-sm-4">
                                    <label for="exampleInputEmail1">دایرکتوری عکس:</label>
                                    <input type="text" name="image_directory" value="{{ $post->imageDirectory }}"
                                           class="form-control ">
                                </div>
                            </div>
                            <br>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ $post->stream_url }}" name="stream_url" class="form-control ">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control " name="related_post_id">
                                ...
                                @foreach($posts as $postItem)
                                    <option
                                        value="{{ $postItem->id }}" {{ $post->related_post_id == $postItem->id ? "selected" : "" }}>
                                        {{ $postItem->title }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-inline ">
                            ...
                            <div class="form-group mx-sm-3 mb-2">
                                <input type="text" value="{{ $post->time_to_read }}" name="time_to_read"
                                       class="form-control"
